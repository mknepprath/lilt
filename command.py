            ...
            if dbrend[0] == 'item':
                ...
                if dbrend[1] == 'insert':
                    ...
                    if len(dbfetch) < 1:
                        ...
                        return (True, str(dbfetch[0]) + ' was fetched from ' + dbrend[2].capitalize() + '.')
                    elif len(dbfetch) > 1:
                        return (True, str(dbfetch[0]) + ' was fetched from ' + dbrend[2].capitalize() + ', along with ' + str(len(dbfetch) - 1) + ' others.')
                elif dbrend[1] == 'update':
