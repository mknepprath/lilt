        ...
        try:
            ...
            if user_exists != None:
                ...
                if move == 'start':
                    ...
                    cur.execute("INSERT INTO users (name, id, last_tweet_id, position, inventory, events) VALUES (%s, %s, %s, %s, %s, %s)", (screen_name, user_id, tweetid, str('start'), json.dumps({}), json.dumps({str('room'):{}})))
                    conn.commit()
                    reply = True
                else:
